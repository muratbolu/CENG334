...
#define EXT2_DIR_LENGTH(name_length)                                           \
    (sizeof(struct ext2_dir_entry) + CEIL(name_length, 4U) * 4U)

#ifdef EXT2_DEBUG
#define ext2_debug(f, a...)                                                    \
    {                                                                          \
        fprintf(stderr,                                                        \
                "EXT2S-fs DEBUG (%s, %d): %s: ",                               \
                __FILE__,                                                      \
                __LINE__,                                                      \
                __func__);                                                     \
        fprintf(stderr, f, ##a);                                               \
...
void print_group_descriptor(
  const struct ext2_block_group_descriptor* group_descriptor);
